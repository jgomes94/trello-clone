...
const API_URL = process.env.API_URL ? process.env.API_URL : 'https://va3ijysqw3.execute-api.eu-west-1.amazonaws.com'; //necessary to change for where is the backend
